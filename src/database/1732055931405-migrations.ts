...
export class Migrations1732055931405 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_9fb1e92b8dda9d974c5e1ac003" ON "fx_rates" ("source_currency", "destination_currency") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_9fb1e92b8dda9d974c5e1ac003"`);
